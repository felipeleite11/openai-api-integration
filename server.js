...
const { completion, textToSpeech, speechToText, translateAudioToEnglish, completionFromAudio, listAssistants, retrieveAssistant, sendToAssistant, chatCompletion, createImage } = require('./app/services/openai')
...
app.post('/completion-from-audio', upload.single('input'), async (req, res) => {
	const extension = extname(req.file.originalname)
...
app.get('/retrieve-assistant/:id', async (req, res) => {
